 ...
 */
export function checkValidity(sourceData: SourceData.Desc): ValueMessageReturn<boolean> {
 ...
 */
export function wrapFlatRecordArrayIntoSinglePartition(records: SourceData.RecordArray): SourceData.PartitionedRecordArray {
    return [records];
}
 ...
 */
export function convertToPartitionedRecordArrayDesc(sourceData: SourceData.Desc) {
