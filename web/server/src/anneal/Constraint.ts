...
export const checkValidity =
    (constraint: Constraint.Desc): ValueMessageReturn<boolean> => {
...
export const isApplicabilityConditionsArray =
    (constraint: Constraint.Desc) => {
        return Array.isArray(constraint.applicabilityConditions);
    }

export const isFilterFunctionValid =
    (constraint: Constraint.Desc) => {
...
export const isFilterSearchValuesNonEmpty =
    (constraint: Constraint.Desc) => {
        // Ignore similarity type constraints
        if (constraint.type === "similarity") {
            return true;
...
export const isFilterFunctionValidForSearchValues =
    (constraint: Constraint.Desc) => {
        // Ignore similarity type constraints
        if (constraint.type === "similarity") {
            return true;
